        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-20">
          ...
          <ScrollReveal delay={0.1} className="flex flex-col gap-8">
            ...
            <a
              ...
              className="group inline-flex items-center gap-3 border border-[#13181B] text-[#13181B] text-sm font-semibold px-6 py-4 rounded-full hover:bg-[#13181B] hover:text-[#F4F4F5] transition-colors w-fit"
            >
              Connect on LinkedIn
